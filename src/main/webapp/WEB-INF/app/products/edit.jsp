<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>JPOS - Edit Product ${String.format("%s", product.getName())}
            </title>
                            ...
                            <div>
                                <c:if test="${not empty product}">
                                    <form action="${pageContext.request.contextPath}/app/products/edit" method="post">
                                        <input class="d-none" type="text" name="product_id"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                id="name" name="name" value="${product.getName()}" readonly required
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea type="description"
                                                ...
                                                placeholder="e.g., Milk tea with ice"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="number"
                                                        ...
                                                        id="limit" name="limit" value="${product.getLimit()}" min="1"
                                                        step="1">
                                                    <div class="input-group-append">
                                                        <span class="input-group-text">item/s</span>
                                                    </div>
                                ...
                                <c:if test="${empty product}">
                                    <div class="alert alert-danger">
                                        You did not select an product to edit!
                                    </div>
                                </c:if>
                            </div>
