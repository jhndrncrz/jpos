<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <head>
            ...
            <title>JPOS - View Product ${String.format("%s", product.getName())}
            </title>
                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Products > View</h1>
                                <div class="d-sm-flex align-items-center" style="gap: 1rem;">
                                    <a href="${pageContext.request.contextPath}/app/products/edit?product_id=${product.getProductId()}"
                                        class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                            class="fas fa-pen fa-sm text-white-50"></i> Edit Product</a>
                            ...
                            <div>
                                <c:if test="${not empty product}">
                                    <form action="${pageContext.request.contextPath}/app/products/edit" method="post">
                                        <div class="form-group">
                                            <label for="username">Username</label>
                                            <input type="text" class="form-control" id="username" name="username"
                                                value="${product.getUsername()}" readonly required
                                        ...
                                        <div class="row">
                                            <div class="col form-group">
                                                ...
                                                <input type="text" class="form-control" id="first_name"
                                                    name="first_name" readonly value="${product.getFirstName()}"
                                            ...
                                            <div class="col form-group">
                                                ...
                                                <input type="last_name" class="form-control" id="last_name"
                                                    name="last_name" readonly value="${product.getLastName()}" required
                                                    placeholder="e.g., Doe">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="role" name="role" required readonly>
                                                <option value="product" ${product.getRole()=="product" ? "selected"
                                                    : "" }>Product</option>
                                                <option value="admin" ${product.getRole()=="admin" ? "selected" : "" }>
                                                    Admin</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" id="salary" name="salary"
                                                    value="${product.getSalary()}" step="0.01" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="email">Email Address</label>
                                            <input type="email" class="form-control" id="email" name="email" required
                                                placeholder="e.g., johndoe@jpos.com" value="${product.getEmail()}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="phone_number">Phone Number</label>
                                            <input type="tel" class="form-control" id="phone_number" name="phone_number"
                                                placeholder="e.g., John" value="${product.getPhoneNumber()}" readonly>
                                        </div>
                                    </form>
                                </c:if>
                                <c:if test="${empty product}">
                                    <div class="alert alert-danger">
                                        You did not select an product to view!
                                    </div>
                                </c:if>
                            </div>
