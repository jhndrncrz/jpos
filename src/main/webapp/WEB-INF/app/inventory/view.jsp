                            ...
                            <div>
                                    ...
                                    <form action="${pageContext.request.contextPath}/app/employees/edit" method="post">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="itemName" name="itemName"
                                                value="${inventory.getItemName()}" readonly required>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="basePrice">Price per Item</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Php</span>
                                                </div>
                                                <input type="number" class="form-control" id="basePrice" name="basePrice"
                                                    value="${inventory.getBasePrice()}" step="0.01" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="stock">Currently in Stock</label>
                                            <input type="number" class="form-control" id="stock" name="stock" required
                                                 value="${inventory.getStock()}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="totalPrice">Total Price of Stock</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Php</span>
                                                </div>
                                                <input type="number" class="form-control" id="totalPrice" name="totalPrice"
                                                    value="${inventory.getTotalPrice()}" step="0.01" readonly>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="floorAmount">Minimum Amount in Stock(Resupply immediently if stock falls below this value)</label>
                                            <input type="number" class="form-control" id="floorAmount" name="floorAmount" required
                                                value="${inventory.getFloorAmount()}"
                                                readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="stock">Maximum Amount in Stock(No need for resupply if stock falls above this value)</label>
                                            <input type="number" class="form-control" id="stock" name="stock" required
                                                value="${inventory.getRoofAmount()}"
                                                readonly>
                                        </div>
                                    </form>
                                </c:if>
                                <c:if test="${empty inventory}">
                                    <div class="alert alert-danger">
                                        You did not select an item to view!
                                    </div>
                                </c:if>
                            </div>
